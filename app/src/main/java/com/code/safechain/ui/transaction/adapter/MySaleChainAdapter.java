 ...
 * @Description:
 */
public class MySaleChainAdapter extends BaseAdapter  {
    private List<WalletHomeRsBean.ResultBean.DataBean> mList;
    private Context mContext;

    public MySaleChainAdapter(Context pContext, List<WalletHomeRsBean.ResultBean.DataBean> pList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView!=null) {
            ...
            paytype.setText(mList.get(position).getSymbol());
        }
        return convertView;
    }
}
