...
public class PayTypeAdapter extends BaseAdapter  {
    private List<OthersSaleOrderRsBean.ResultBean.PaysBean> mList;
    private Context mContext;

    public PayTypeAdapter(Context pContext, List<OthersSaleOrderRsBean.ResultBean.PaysBean> pList) {
